...
export class BootstrapResizableDirective {
    ...
    constructor(private $attrs: ng.IAttributes,
        ...
        $element[0].addEventListener('mousedown', (e: MouseEvent) => this.down(e), false);
        $element[0].addEventListener('touchstart', (e: MouseEvent) => this.down(e), false);
    ...
    dragging(e: MouseEvent) {
        ...
        // console.log("RIGHT", newColumns, this.$element[0].clientWidth, this.w - offset);
