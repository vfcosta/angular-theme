...
import { SuggestArticleTaskAcceptComponent } from "../types/suggest-article/suggest-article-task-accept.component";
import { AddFriendTaskAcceptComponent } from "../types/add-friend/add-friend-task-accept.component";

@Component({
    selector: 'task-accept',
    template: '<div></div>',
    directives: [AddMemberTaskAcceptComponent, ApproveCommentTaskAcceptComponent, AbuseComplaintTaskAcceptComponent, ApproveArticleTaskAcceptComponent, SuggestArticleTaskAcceptComponent, AddFriendTaskAcceptComponent]
})
