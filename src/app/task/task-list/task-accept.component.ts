...
@Component({
    ...
    template: '<div></div>',
    directives: [AddMemberTaskAcceptComponent, ApproveCommentTaskAcceptComponent, ApproveArticleTaskAcceptComponent, SuggestArticleTaskAcceptComponent, AddFriendTaskAcceptComponent]
})
