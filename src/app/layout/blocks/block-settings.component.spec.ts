...
describe("Components", () => {
    describe("Block Component", () => {
        ...
        it("receives the block and the owner as inputs", done => {
            ...
            @Component({ selector: 'test-container-component', template: htmlTemplate, directives: [BlockSettingsComponent] })
            ...
            tcb
                .createAsync(BlockContainerComponent).then(fixture => {
                    ...
                    let myComponent: BlockSettingsComponent = fixture.componentInstance;
        ...
        it("renders a component which matches to the block type", done => {
            ...
            @Component({ selector: 'test-container-component', template: htmlTemplate, directives: [BlockSettingsComponent, CustomBlockSettings] })
