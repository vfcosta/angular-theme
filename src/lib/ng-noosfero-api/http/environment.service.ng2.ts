...
import { EnvironmentService as EnvironmentServiceNg1 } from "./environment.service";
...
export class EnvironmentService extends RestangularService<noosfero.Environment> {
    ...
    constructor(protected restangular: Restangular, @Inject("environmentService") private environmentService: EnvironmentServiceNg1) {
        super(restangular);
