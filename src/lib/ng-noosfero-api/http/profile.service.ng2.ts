...
import { ProfileService as ProfileServiceNg1 } from "./profile.service";
...
export class ProfileService extends RestangularService<noosfero.Profile> {
    ...
    constructor(protected restangular: Restangular, @Inject("profileService") private profileService: ProfileServiceNg1) {
        super(restangular);
