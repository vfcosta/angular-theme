    ...
    describe("Task Service", () => {
        ...
        describe("Succesfull requests", () => {
            ...
            it("list pending tasks", (done) => {
                $httpBackend.expectGET(`/api/v1/tasks?all_pending=true&status=1&content_type=AddMember,ApproveComment,ApproveArticle,AbuseComplaint,SuggestArticle`).respond(200, { tasks: [{ id: 1 }] });
